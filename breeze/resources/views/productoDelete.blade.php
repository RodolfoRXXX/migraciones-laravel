        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <h1 class="pb-4">Baja de un producto</h1>
    <!-- formulario -->
                    ...
                    Se eliminará el siguiente producto:
                        ...
                        @csrf
                            <div class="p-6 bg-white">
                                <label for="prdNombre" class="block text-sm font-medium text-gray-500">
                                    Nombre del producto
                                </label>
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    <input type="text" name="prdNombre"
                                           value="{{ $Producto->prdNombre }}"
                                           id="prdNombre" class="p-2  text-yellow-700 text-2xl focus:ring-yellow-300 focus:border-yellow-300 flex-1 block w-full rounded-none rounded-r-md border-gray-300">
                                </div>
                                ...
                                <div class="py-6 flex items-center justify-end">
                                    ...
                                    <a href="/productos" class="text-yellow-600 hover:text-yellow-500
